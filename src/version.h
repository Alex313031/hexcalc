#ifndef HEXCALC_VERSION_H_
#define HEXCALC_VERSION_H_
...
#define APP_NAME        L"HexCalc"   // Name of the App
#define MAIN_WNDCLASS   L"HexCalcWin32" // Our main Window Class unique name

#define COMMENTS        L"https://github.com/Alex313031/hexcalc" // Project GitHub URL
#define COMPANYNAME     L"Alex313031" // My developer name
#define FILE_DESCRIPT   L"Programmer's Number Type Calculator" // File description
#define INTERNAL_NAME   L"hexcalc" // "Internal" name, also used for .exe name
...
#define ABOUT_CONTENT   L"A Programmer's Calculator"
